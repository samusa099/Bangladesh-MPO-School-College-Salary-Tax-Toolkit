...
Do not mark a release **Verified** while active public surfaces disagree on the release number or while the Git tag differs from the canonical product release.
