...
The project separates engineering work from public distribution.

## GitHub role

GitHub is the engineering workspace. It contains:
...
Kaggle is the clean distribution package. It contains:
